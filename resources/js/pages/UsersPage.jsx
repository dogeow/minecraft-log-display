              ...
              <thead>
                <tr className="border-b bg-muted/50">
                  <th className="px-4 py-2 text-left">
                    <SortButton field="username">用户名</SortButton>
                  </th>
                  <th className="px-4 py-2 text-left">状态</th>
                  <th className="px-4 py-2 text-left">
                    <SortButton field="last_logout_at">离线/登录</SortButton>
                  </th>
                  <th className="px-4 py-2 text-left">总在线时长</th>
                  <th className="px-4 py-2 text-left">
                    <SortButton field="is_scientist">标记</SortButton>
                  </th>
                </tr>
              </thead>
              <tbody>
                {users.data.map((user) => (
                  <tr
                    key={user.id}
                    className={user.is_online ? "bg-green-500/10" : ""}
                  >
